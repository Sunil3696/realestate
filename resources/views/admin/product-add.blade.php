...
@section('main-content')
            ...
            <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                    <div class="mr-md-3 mr-xl-5">
                        <h2>{{ isset($edit_data) ? 'Update' : 'Add' }} New Product</h2>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ isset($edit_data) ? route('edit_update',$edit_data->id) : route('product_submit') }}" method="post" class="form" enctype="multipart/form-data">
                @csrf
