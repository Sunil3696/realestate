...
@section('main-content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ route('update_about') }}" class="form" method="post">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <textarea name="content" id="brief_desc" cols="30" rows="10" placeholder="Please enter About us Content Here" class="form-control"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-3">
